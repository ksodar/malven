    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product_tabs" class="form-horizontal">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-show-empty-tab"><?php echo $entry_show_empty_tab; ?></label>
                <div class="col-sm-10">
                  <select name="show_empty_tab" id="input-show-empty-tab" class="form-control">
                    <?php if ($show_empty_tab) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<span class="icon_open" id="icon_tabs" onclick="icon_fontawesome_popup($(this).attr('id'))">
						<?php echo $text_select_icon;?>
						<?php if(isset($icon_tabs)) { ?><i class="<?php echo $icon_tabs; ?>"></i><?php } ?></span>
						<input class="form-control" type="hidden"  name="icon_tabs" value="<?php echo $icon_tabs;?>"/>
					</div>
				</div>
              <div class="form-group">
