<div class="modal-dialog modal-lg">
  <div class="modal-content">
	...
	<div class="modal-footer">
	  <div class="text-center"><a onclick="CKupdate();saveEditor();" class="button-save btn btn-info btn-lg" data-form="form-product-tab-group-add"><i class="fa fa-save fa-fw"></i><?php echo $button_save;?></a></div>
	</div>
	<script type="text/javascript">
function CKupdate(){
<?php foreach ($languages as $language) { ?>
$('textarea[name="product_extra_tab[<?php echo $language['language_id']; ?>][product_extra_tab_description]"]').html($('#language<?php echo $language['language_id']; ?> .note-editable').code());
<?php } ?>
}
</script>
<script type="text/javascript">
