	...
	<div class="col-sm-9">
		<div class="radio-group-infinity">
			<?php if ($config_menu_always_open_on_the_left) { ?>
				...
				<label for="config_menu_always_open_on_the_left_yes"><?php echo $text_yes; ?></label>
			<?php } else { ?>
			...
			<?php } ?>
				...
				<label for="config_menu_always_open_on_the_left_no"><?php echo $text_no; ?></label>
			<?php } else { ?>
...
<div class="form-group menu_always_open">
	...
	<span><?php echo $text_menu_open_category;?></span><br>
		<div class="radio-group-infinity">
			<?php if ($config_menu_open_category) { ?>
				...
				<label for="config_menu_open_category_yes"><?php echo $text_yes; ?></label>
			<?php } else { ?>
			...
			<?php } ?>
				...
				<label for="config_menu_open_category_no"><?php echo $text_no; ?></label>
			<?php } else { ?>
	...
	<span><?php echo $text_menu_open_special;?></span><br>
		<div class="radio-group-infinity">
			...
			<?php } ?>
				...
				<label for="config_menu_open_special_no"><?php echo $text_no; ?></label>
			<?php } else { ?>
	...
	<span><?php echo $text_menu_open_search;?></span><br>
		<div class="radio-group-infinity">
			...
			<?php } ?>
				...
				<label for="config_menu_open_search_no"><?php echo $text_no; ?></label>
			<?php } else { ?>
	...
	<span><?php echo $text_menu_open_information;?></span><br>
		<div class="radio-group-infinity">
			<?php if ($config_menu_open_information) { ?>
				...
				<label for="config_menu_open_information_yes"><?php echo $text_yes; ?></label>
			<?php } else { ?>
			...
			<?php } ?>
				...
				<label for="config_menu_open_information_no"><?php echo $text_no; ?></label>
			<?php } else { ?>
	...
	<span><?php echo $text_menu_open_manufacturer;?></span><br>
		<div class="radio-group-infinity">
			<?php if ($config_menu_open_manufacturer) { ?>
				...
				<label for="config_menu_open_manufacturer_yes"><?php echo $text_yes; ?></label>
			<?php } else { ?>
			...
			<?php } ?>
				...
				<label for="config_menu_open_manufacturer_no"><?php echo $text_no; ?></label>
			<?php } else { ?>
...
<div class="form-group">
				<label class="col-sm-3 control-label"><?php echo $text_category_add_auto;?>
				<div class="label-description-exclamation"><i class="fa fa-exclamation-triangle required"></i> <?php echo $text_category_add_auto_description;?></div>
				</label>
				<div class="col-sm-9 title-setting"><button type="button" class="btn btn-success" id="autocategoryadd" data-loading-text='<?php echo $text_creating_categories;?>'><?php echo $btn_category_add_auto;?></button></div>
			</div>
...
$('#autocategoryadd').bind('click',function() {
				...
				var success = 'false';				
					$.ajax({
						...
						url:'index.php?route=module/settingnewstore/autocategoryadd&token=<?php echo $token; ?>',	
						beforeSend: function() {
				...
				<div class="tab-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<?php foreach ($languages as $language) { ?>
									<div class="input-group pull-left">
										<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
										<input class="form-control" type="text" name="config_menu_item[<?php echo $menu_item_row; ?>][link][<?php echo $language['language_id']?>]" value="<?php echo isset($config_menu_item['link'][$language['language_id']]) ? $config_menu_item['link'][$language['language_id']]: ''; ?>" />
									</div>
								<?php } ?>
							</div>
						</div>
							...
							<div class="col-sm-10">
								<div class="well well-sm">
									<?php foreach($manufacturers_list as $manufacturer){?>
										<div class="checkbox">
											<label>
												<input type="checkbox" name="config_menu_item[<?php echo $menu_item_row; ?>][manufacturers_list][]" <?php if(isset($manufacturers_list_selected[$menu_item_row][$manufacturer['manufacturer_id']])){?> checked="checked" <?php } ?> value="<?=$manufacturer['manufacturer_id']?>"/> <?=$manufacturer['name']?> 
											</label>
										</div>
									<?php } ?>
								</div>
							...
							<div class="col-sm-10">
								<div class="well well-sm">
									<?php foreach($informations_list as $information){ ?>
										<div class="checkbox">
											<label>
												<input type="checkbox" name="config_menu_item[<?php echo $menu_item_row; ?>][informations_list][]" <?php if(isset($informations_list_selected[$menu_item_row][$information['information_id']])){?> checked="checked" <?php } ?> value="<?=$information['information_id']?>"/> <?=$information['title']?> 
											</label>
										</div>
									<?php } ?>                
								</div>
					...
					<div class="tab-pane fade" id="tab-link-<?php echo $menu_item_row; ?>_options">
						<div class="tab-content">
							...
							<div class="col-sm-9">
								<select id="input-new_blank" name="config_menu_item[<?php echo $menu_item_row; ?>][new_blank]" class="form-control">
									<?php if ($config_menu_item['new_blank']) { ?>
										<option value="1" selected="selected"><?php echo $text_enabled; ?></option>
										<option value="0"><?php echo $text_disabled; ?></option>
									<?php } else { ?>
										<option value="1"><?php echo $text_enabled; ?></option>
...
function addItemCategoryBanner() {
	...
	html +='			<div class="input-group pull-left">';
	html +='				<span class="input-group-addon"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>';
	html +='				<input class="form-control" type="text" name="config_menu_item['+ menu_item_row +'][link][<?php echo $language['language_id']; ?>]" value="" />';
	html +='			</div>';
	html +='		<?php } ?>';
	html +='	</div>';
	html +='</div>';
