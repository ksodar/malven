			...
			<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="radio-group-infinity">	
							<?php if ($config_show_newstorecheckout) { ?>
							<input id="config_show_newstorecheckout_yes" class="hide-radio" type="radio" name="config_show_newstorecheckout" value="1" checked="checked" />
							<label for="config_show_newstorecheckout_yes"><?php echo $text_yes; ?></label>
							<?php } else { ?>
							<input id="config_show_newstorecheckout_yes" class="hide-radio" type="radio" name="config_show_newstorecheckout" value="1" />
							<label for="config_show_newstorecheckout_yes"><?php echo $text_yes; ?></label>
							<?php } ?>
							<?php if (!$config_show_newstorecheckout) { ?>
							<input id="config_show_newstorecheckout_no" class="hide-radio" type="radio" name="config_show_newstorecheckout" value="0" checked="checked" />							
							<label for="config_show_newstorecheckout_no"><?php echo $text_no; ?></label>
							<?php } else { ?>
							<input id="config_show_newstorecheckout_no" class="hide-radio" type="radio" name="config_show_newstorecheckout" value="0" />							
							<label for="config_show_newstorecheckout_no"><?php echo $text_no; ?></label>
							<?php } ?>						  
						</div>						 
					</div>
