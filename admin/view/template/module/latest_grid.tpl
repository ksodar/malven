  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		 <a onclick="clear_cache();" href="javascript:void('0')"  title="<?php echo $button_clear_cache; ?>" class="btn btn-warning"><?php echo $button_clear_cache; ?></a>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status-cache"><?php echo $entry_status_cache; ?></label>
            <div class="col-sm-10">
              <select name="status_cache" id="input-status-cache" class="form-control">
                <?php if ($status_cache) { ?>
...
function clear_cache(){
		...
		$(".alert").remove();
			$.ajax({
				type:'get',
				dataType:'json',
				url:'index.php?route=module/latest_grid/clear_cache&token=<?php echo $token; ?>',			
