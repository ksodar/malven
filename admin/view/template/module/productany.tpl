      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-productany" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="color" name="config_title_color_text_productany" value="<?php echo $config_title_color_text_productany; ?>" placeholder="<?php echo $config_title_color_text_productany; ?>" id="input-color-text" class="form-control" />
            </div>
          </div>
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-color-text"><?php echo $entry_title_background; ?></label>
            <div class="col-sm-10">
              <input type="color" name="config_title_background" value="<?php echo $config_title_background; ?>" placeholder="<?php echo $config_title_background; ?>" id="input-color-text" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div id="productany-product" class="well well-sm" style="height: 150px; overflow: auto;">
                ...
                <div id="productany-product<?php echo $product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product['name']; ?>
...
$('input[name=\'product\']').autocomplete({
	...
	select: function(item) {
		...
		$('#productany-product').append('<div id="productany-product' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product[]" value="' + item['value'] + '" /></div>');	
	}
});
