...
class ControllerModuleFeatured extends Controller {
	public function index($setting) {
		$this->load->language('module/featured');
			...
			$data['ns_on_off_featured_model_product'] = $this->config->get('config_on_off_featured_model_product'); //added	
			$data['ns_on_off_featured_description'] = $this->config->get('config_on_off_featured_description'); //added	
			$data['ns_on_off_featured_slider_additional_image'] = $this->config->get('config_on_off_featured_slider_additional_image'); //added	
			$data['ns_select_featured_additional_animate_method'] = $this->config->get('config_select_featured_additional_animate_method'); //added	
			$data['ns_on_off_featured_rating'] = $this->config->get('config_on_off_featured_rating'); //added	
			$data['ns_on_off_featured_quantity_reviews'] = $this->config->get('config_on_off_featured_quantity_reviews'); //added	
			$data['ns_on_off_featured_fastorder'] = $this->config->get('config_on_off_featured_fastorder'); //added	
			$data['ns_on_off_featured_wishlist'] = $this->config->get('config_on_off_featured_wishlist'); //added	
			$data['ns_on_off_featured_compare'] = $this->config->get('config_on_off_featured_compare'); //added	
		...
		'date_available'			=> $product_info['date_available'],//added
		'viewed'	 				=> $product_info['viewed'], //added
