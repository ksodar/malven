...
class ControllerModuleLatest extends Controller {
	public function index($setting) {
		$this->load->language('module/latest');
			...
			$data['heading_title_latest'] = $this->language->get('heading_title_latest'); //added	
			$data['ns_on_off_latest_model_product'] = $this->config->get('config_on_off_latest_model_product'); //added	
			$data['ns_on_off_latest_description'] = $this->config->get('config_on_off_latest_description'); //added	
			$data['ns_on_off_latest_slider_additional_image'] = $this->config->get('config_on_off_latest_slider_additional_image'); //added	
			$data['ns_select_latest_additional_animate_method'] = $this->config->get('config_select_latest_additional_animate_method'); //added	
			$data['ns_on_off_latest_rating'] = $this->config->get('config_on_off_latest_rating'); //added	
			$data['ns_on_off_latest_quantity_reviews'] = $this->config->get('config_on_off_latest_quantity_reviews'); //added	
			$data['ns_on_off_latest_fastorder'] = $this->config->get('config_on_off_latest_fastorder'); //added	
			$data['ns_on_off_latest_wishlist'] = $this->config->get('config_on_off_latest_wishlist'); //added	
			$data['ns_on_off_latest_compare'] = $this->config->get('config_on_off_latest_compare'); //added	
			/*-----*/
