...
class ControllerModuleBestSeller extends Controller {
	public function index($setting) {
		$this->load->language('module/bestseller');
			...
			$data['ns_on_off_bestseller_model_product'] = $this->config->get('config_on_off_bestseller_model_product'); //added	
			$data['ns_on_off_bestseller_description'] = $this->config->get('config_on_off_bestseller_description'); //added	
			$data['ns_on_off_bestseller_slider_additional_image'] = $this->config->get('config_on_off_bestseller_slider_additional_image'); //added	
			$data['ns_select_bestseller_additional_animate_method'] = $this->config->get('config_select_bestseller_additional_animate_method'); //added	
			$data['ns_on_off_bestseller_rating'] = $this->config->get('config_on_off_bestseller_rating'); //added	
			$data['ns_on_off_bestseller_quantity_reviews'] = $this->config->get('config_on_off_bestseller_quantity_reviews'); //added	
			$data['ns_on_off_bestseller_fastorder'] = $this->config->get('config_on_off_bestseller_fastorder'); //added	
			$data['ns_on_off_bestseller_wishlist'] = $this->config->get('config_on_off_bestseller_wishlist'); //added	
			$data['ns_on_off_bestseller_compare'] = $this->config->get('config_on_off_bestseller_compare'); //added	
			/*-----*/
		...
		if ($results) {
			...
			$additional_image_hover_on_off = $this->config->get('config_on_off_bestseller_slider_additional_image');
