...
class ControllerProductManufacturer extends Controller {
	public function index() {
		$this->load->language('product/manufacturer');
			...
			/*on_off*/
			$data['ns_on_off_manufacturer_page_model_product'] 				= $this->config->get('config_on_off_manufacturer_page_model_product'); //added	
			$data['ns_on_off_manufacturer_page_description'] 				= $this->config->get('config_on_off_manufacturer_page_description'); //added	
			$data['ns_on_off_manufacturer_page_slider_additional_image'] 	= $this->config->get('config_on_off_manufacturer_page_slider_additional_image'); //added	
			$data['ns_select_manufacturer_page_additional_animate_method'] 	= $this->config->get('config_select_manufacturer_page_additional_animate_method'); //added	
			$data['ns_on_off_manufacturer_page_rating'] 					= $this->config->get('config_on_off_manufacturer_page_rating'); //added	
			$data['ns_on_off_manufacturer_page_quantity_reviews'] 			= $this->config->get('config_on_off_manufacturer_page_quantity_reviews'); //added	
			$data['ns_on_off_manufacturer_page_fastorder'] 					= $this->config->get('config_on_off_manufacturer_page_fastorder'); //added	
			$data['ns_on_off_manufacturer_page_wishlist'] 					= $this->config->get('config_on_off_manufacturer_page_wishlist'); //added	
			$data['ns_on_off_manufacturer_page_compare'] 					= $this->config->get('config_on_off_manufacturer_page_compare'); //added	
			/*-----*/
