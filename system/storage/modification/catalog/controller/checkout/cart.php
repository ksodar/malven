...
class ControllerCheckoutCart extends Controller {
	public function index() {
		...
		if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			$config_show_newstorecheckout = $this->config->get('config_show_newstorecheckout');
			if ($config_show_newstorecheckout == '1') {
	...
	public function add() {
		...
		if ($product_info) {
			...
			$json['show_newstorecheckout'] = $this->config->get('config_show_newstorecheckout');
				$this->load->model('tool/image');
				...
				$json['total'] = sprintf($this->language->get('text_items_my'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0), $this->currency->format($total));
