...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
        ...
        <li class="dropdown"><a data-placement="bottom" data-toggle="tooltip" title="<?php echo $title_fastorder ?>" class="dropdown-toggle" href="<?php echo $newfastorder ;?>"><span class="label label-danger pull-left"><?php echo $countfastorder; ?></span> <i class="fa fa-shopping-cart fa-lg"></i></a><!--add-->
			

			 <?php if (isset($found_cheaper_product['status']) && $found_cheaper_product['status']) { ?>
				<li class="dropdown"><a data-placement="bottom" data-toggle="tooltip" title="<?php echo $title_icon_header_fcp; ?>" class="dropdown-toggle" href="<?php echo $found_cheaper_product_url ;?>"><span class="label label-danger pull-left"><?php echo $countfound_cheaper; ?></span> <i class="fa fa fa-bullhorn fa-lg"></i></a></li>
			<?php } ?>
			

        <li class="dropdown"><a class="dropdown-toggle" href="<?php echo $callback ;?>"><span class="label label-danger pull-left"><?php echo $countcallback; ?></span> <i class="fa fa-phone-square fa-lg"></i></a><!--add-->
