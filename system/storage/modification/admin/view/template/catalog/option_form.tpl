  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="input-status_color_type"><?php echo $entry_status_color_type; ?></label>
            <div class="col-sm-10">
              <select name="status_color_type" id="input-status_color_type" class="form-control">
                <?php if ($status_color_type) { ?>
        ...
        <td class="text-left"><?php echo $entry_color; ?></td>
         ...
         <td class="text-left">
			<input class="form-control color" type="text" name="option_value[<?php echo $option_value_row; ?>][color]" value="<?php echo $option_value['color']; ?>" />
		</td>
