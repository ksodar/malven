  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <li><a href="#tab-product" data-toggle="tab"><?php echo $tab_product_tabs; ?></a></li>
        <?php } ?>
        ...
        <div class="tab-pane" id="tab-product">
          <div class="col-sm-2">
            <ul class="nav nav-pills nav-stacked" id="extra_tabs">
              ...
              <?php foreach ($product_tabs_ns as $product_tab_ns) { ?>
              <li><a href="#tab-product<?php echo $product_tab_row; ?>" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$('a[href=\'#tab-product<?php echo $product_tab_row; ?>\']').parent().remove(); $('#tab-product<?php echo $product_tab_row; ?>').remove(); $('#extra_tabs a:first').tab('show');"></i> <?php echo $product_tab_ns['title']; ?></a></li>
              <?php $product_tab_row++; ?>
              <?php } ?>
              <li>
                <input type="text" name="extra_tabs" value="" placeholder="<?php echo $entry_product_tab; ?>" id="input-extra_tabs" class="form-control" />
              </li>
            </ul>
          </div>
          <div class="col-sm-10">
            <div class="tab-content">
              <?php $product_tab_row = 0; ?>
              <?php foreach ($product_tabs_ns as $product_tab_ns) { ?>
              <div class="tab-pane" id="tab-product<?php echo $product_tab_row; ?>">
                <input type="hidden" name="product_tab_ns[<?php echo $product_tab_row; ?>][title]" value="<?php echo $product_tab_ns['title']; ?>" />
                <input type="hidden" name="product_tab_ns[<?php echo $product_tab_row; ?>][tabs_ns_id]" value="<?php echo $product_tab_ns['tabs_ns_id']; ?>" />
                <ul class="nav nav-tabs" id="product_tab_description_div<?php echo $product_tab_row; ?>">
                  <?php foreach ($languages as $language) { ?>
                  <li><a href="#extra_tab_description<?php echo $product_tab_row; ?><?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                  <?php } ?>
                </ul>
                <div class="tab-content">
                  <?php foreach ($languages as $language) { ?>
                  <div class="tab-pane" id="extra_tab_description<?php echo $product_tab_row; ?><?php echo $language['language_id']; ?>">
                    <textarea name="product_tab_ns[<?php echo $product_tab_row; ?>][product_tab_ns_description][<?php echo $language['language_id']; ?>][text]" placeholder="<?php echo $entry_text; ?>" class="form-control summernote"><?php echo isset($product_tab_ns['product_tab_ns_description'][$language['language_id']]) ? $product_tab_ns['product_tab_ns_description'][$language['language_id']]['text'] : ''; ?></textarea>
                  </div>
                  <?php } ?>
                </div>
              </div>
          ...
          <script type="text/javascript">
              ...
              'select': function(item) {
                html  = '<div class="tab-pane" id="tab-product'+product_tab_row+'">';
                  ...
                  html  += '<ul class="nav nav-tabs" id="product_tab_description_div'+product_tab_row+'">';
                    <?php foreach ($languages as $language) { ?>
                    html  += '<li><a href="#extra_tab_description'+product_tab_row+'<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
                    <?php } ?>
                  html  += '</ul>';
                  html  += '<div class="tab-content">';
                    <?php foreach ($languages as $language) { ?>
                    html  += '<div class="tab-pane" id="extra_tab_description'+product_tab_row+'<?php echo $language['language_id']; ?>">';
                      html  += '<textarea name="product_tab_ns['+product_tab_row+'][product_tab_ns_description][<?php echo $language['language_id']; ?>][text]" placeholder="<?php echo $entry_text; ?>" class="form-control summernote"></textarea>';
                    html  += '</div>';
                    <?php } ?>
                  html  += '</div>';
                html  += '</div>';
            ...
            <?php $product_tab_row = 0; ?>
            <?php foreach ($product_tabs_ns as $product_tab_ns) { ?>
              $('#product_tab_description_div<?php echo $product_tab_row; ?> a:first').tab('show');
            <?php $product_tab_row++; ?>
            <?php } ?>
