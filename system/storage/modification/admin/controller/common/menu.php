...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['product_tabs'] = $this->url->link('catalog/product_tabs', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['text_newstore_menu'] = $this->language->get('text_newstore_menu');
        $data['newstore_menu'] = $this->url->link('module/settingnewstore', 'token=' . $this->session->data['token'], 'SSL');
