<?php
class ControllerCommonHomeshemeNewstorePos7 extends Controller {
	public function index() {
		...
		return $this->load->view($this->config->get('config_template') . '/template/common/homesheme/newstore_pos7.tpl', $data);
