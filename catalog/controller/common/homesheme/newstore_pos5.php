<?php
class ControllerCommonHomeshemeNewstorePos5 extends Controller {
	public function index() {
		...
		return $this->load->view($this->config->get('config_template') . '/template/common/homesheme/newstore_pos5.tpl', $data);
