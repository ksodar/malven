<?php
class ControllerCommonHomeshemeNewstorePos1 extends Controller {
	public function index() {
		...
		return $this->load->view($this->config->get('config_template') . '/template/common/homesheme/newstore_pos1.tpl', $data);
