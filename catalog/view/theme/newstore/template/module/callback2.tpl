					...
					<?php if ($callbackpro['skype'] !='') { ?>
						<?php if(isset($callbackpro['show_status_skype'])){?>
							...
							<?php if(($timenow > $callbackpro['skype_date_start']) && ($timenow < $callbackpro['skype_date_end'])) { ?>
								<div class="skype">
									<a class="status_skype" href="skype:?chat"><img src="catalog/view/theme/newstore/image/skype_online.png">&nbsp;<?php echo $callbackpro['skype']; ?></a>
								</div>
							<?php } else { ?>
								<div class="skype">
									<a class="status_skype" href="skype:?chat"><img src="catalog/view/theme/newstore/image/skype_offline.png">&nbsp;<?php echo $callbackpro['skype']; ?></a>
								</div>
							<?php } ?>
						<?php } else { ?>
							<div class="skype">
