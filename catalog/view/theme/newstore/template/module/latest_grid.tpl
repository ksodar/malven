...
<div class="container-modules latest_gv latest_grid<?php echo $module;?>">
	...
	callback	: function(days, hours, minutes, seconds){
	  ...
	  <div class="caption">
	   <div class="actions-quick-order">
		...
		<?php } ?>
		<?php if ($show_options) { ?>
			<div id="option_latest_gv_<?php echo $product['product_id']; ?>" class="option latest-gv-opt">
			<?php foreach ($product['options'] as $key => $option) { ?>
				<?php if ($option['type'] == 'select'){ ?>
					<div class="form-group">
						...
						<div id="input-option-latest_gv<?php echo $option['product_option_id']; ?>">
							<select onchange="recalc_quantity(<?php echo $product['product_id'];?>,<?php echo $product['minimum']; ?>,<?php echo $product['price_no_format'];?>,'<?php echo $product['special_no_format'];?>','.latest_grid<?php echo $module;?>','latest_gv');" name="option[<?php echo $option['product_option_id']; ?>]" id="input-value-<?php echo $option['product_option_id']; ?>_latest_gv" class="form-control">
            ...
            <div class="form-group">
              ...
              <div id="input-option-latest_gv<?php echo $option['product_option_id']; ?>">
                ...
                <div class="radio-checbox-options">
					<input data-option-prefix="<?php echo $option_value['price_prefix']; ?>" data-option-price="<?php echo $option_value['price_value']; ?>" onchange="recalc_quantity(<?php echo $product['product_id'];?>,<?php echo $product['minimum']; ?>,<?php echo $product['price_no_format'];?>,'<?php echo $product['special_no_format'];?>','.latest_grid<?php echo $module;?>','latest_gv');" type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="input-value-<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>_latest_gv" />
					<label for="input-value-<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>_latest_gv">
            ...
            <div class="form-group">
              ...
              <div id="input-option-latest_gv<?php echo $option['product_option_id']; ?>">
                <?php foreach ($option['product_option_value'] as $option_value) { ?>
                <div class="radio-checbox-options">
                  <input data-option-prefix="<?php echo $option_value['price_prefix']; ?>" data-option-price="<?php echo $option_value['price_value']; ?>" onchange="recalc_quantity(<?php echo $product['product_id'];?>,<?php echo $product['minimum']; ?>,<?php echo $product['price_no_format'];?>,'<?php echo $product['special_no_format'];?>','.latest_grid<?php echo $module;?>','latest_gv');" type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="input-value-<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>_latest_gv" />
					<label for="input-value-<?php echo $option['product_option_id']; ?>_<?php echo $option_value['product_option_value_id']; ?>_latest_gv">
                    <span class="option-name"><?php echo $option_value['name']; ?></span>
						<?php if ($option_value['price']) { ?>
						<span class="option-price"><?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?></span>
			...
			<div class="quantity_cont">
				<div class="input-group">
					<span class="input-group-btn">
						<button class="btn btn-quantity-minus" onclick="btnminus_cat_price_latest_gv<?php echo $product['product_id'];?>('<?php echo $product['minimum']; ?>');" type="button">-</button>
					</span>
						<input id="input_quantity_mod_latest_grid<?php echo $module;?><?php echo $product['product_id'];?>" class="form-control input-number-quantity<?php echo $product['product_id'];?>" name="quantity" onkeyup="validate_quantity(this,'<?php echo $product['minimum']; ?>')" oninput="recalc_quantity(<?php echo $product['product_id'];?>,<?php echo $product['minimum']; ?>, <?php echo $product['price_no_format'];?>,'<?php echo $product['special_no_format'];?>','.latest_grid<?php echo $module;?>','latest_gv');" size="2" value="<?php echo $product['minimum']; ?>">
					<span class="input-group-btn">
						<button class="btn btn-quantity-plus" onclick="btnplus_cat_price_latest_gv<?php echo $product['product_id'];?>();" type="button" >+</button>
					</span>
				</div>	
			</div>
		</div>
		<script type="text/javascript">
				function btnminus_cat_price_latest_gv<?php echo $product['product_id'];?>(a){
					document.getElementById("input_quantity_mod_latest_grid<?php echo $module;?><?php echo $product['product_id'];?>").value>a?document.getElementById("input_quantity_mod_latest_grid<?php echo $module;?><?php echo $product['product_id'];?>").value--:document.getElementById("input_quantity_mod_latest_grid<?php echo $module;?><?php echo $product['product_id'];?>").value=a;										
					recalc_quantity(<?php echo $product['product_id'];?>,<?php echo $product['minimum']; ?>,<?php echo $product['price_no_format'];?>,'<?php echo $product['special_no_format'];?>','.latest_grid<?php echo $module;?>','latest_gv');						
				}
				function btnplus_cat_price_latest_gv<?php echo $product['product_id'];?>(){
					document.getElementById("input_quantity_mod_latest_grid<?php echo $module;?><?php echo $product['product_id'];?>").value++;
					recalc_quantity(<?php echo $product['product_id'];?>,<?php echo $product['minimum']; ?>,<?php echo $product['price_no_format'];?>,'<?php echo $product['special_no_format'];?>','.latest_grid<?php echo $module;?>','latest_gv');					
				};																				
		</script>
		<?php } ?>
		<div class="actions">
			...
			<?php } else { ?>
				<div class="cart"><button class="btn btn-general" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>','latest_gv', get_cart_quantity('<?php echo $product['product_id']; ?>','.latest_grid<?php echo $module;?>'));"><?php if($change_text_cart_button_out_of_stock ==1 && $product['product_quantity'] <= 0) { ?><span><?php echo $disable_cart_button_text; ?></span><?php } else { ?><i class="fa fa-shopping-basket"></i> <span><?php echo $button_cart; ?></span><?php } ?></button></div>
			<?php } ?>
...
<script type="text/javascript">
$('.latest_grid<?php echo $module;?>').each(function() {
	if ($(".latest_grid<?php echo $module;?>").parents("#column-left, #column-right, .position-no-owl").length) {
...
$(".latest_grid<?php echo $module;?> .additional-image").removeClass('hidden');	
	$(".latest_grid<?php echo $module;?> .image-carousel").owlCarousel({
				navigation : true, 
				slideSpeed : 300,
				pagination:false,
