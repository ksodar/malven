...
<div class="container-module">
	...
	<div class="product-slider">
		<div class="container-modules featured carousel_numb_featured<?php echo $gen_carousel_featured;?> owl-carousel">
			...
			<div class="item">
				<div itemtype="http://schema.org/Product" itemprop="itemListElement" itemscope class="product-thumb transition">
					...
					<div class="stickers-ns">
						...
						<?php } else { ?>
								<a itemprop="url" href="<?php echo $product['href']; ?>"><img <?php if ($product['product_quantity'] <= 0 && $show_stock_status) { ?>data-status="<?php echo $product['stock_status']; ?>"<?php } ?>src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" class="img-responsive" /></a>
						<?php } ?>
						<?php if($show_special_timer_module =='1' && $product['special']){ ?>
							<div class="action-timer">
								<div id="countdown-featured-<?php echo $gen_carousel_featured;?>-<?php echo $product['product_id'];?>"></div>		
							</div>
							...
							$(function(){
								...
								$('#countdown-featured-<?php echo $gen_carousel_featured;?>-<?php echo $product['product_id'];?>').countdown({
									timestamp	: ts,
...
<script type="text/javascript">
$('.carousel_numb_featured<?php echo $gen_carousel_featured;?>').each(function() {
if ($(".carousel_numb_featured<?php echo $gen_carousel_featured;?>").parents("#column-left, #column-right, .position-no-owl").length) {
...
$(".carousel_numb_featured<?php echo $gen_carousel_featured;?> .additional-image").removeClass('hidden');
	$(".carousel_numb_featured<?php echo $gen_carousel_featured;?> .image-carousel").owlCarousel({
				navigation : true, 
				pagination:false,
