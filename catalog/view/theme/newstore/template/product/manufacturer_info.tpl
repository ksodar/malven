<?php echo $header; ?>
<div class="container">
  <ul class="breadcrumb <?php if (($menu_open_manufacturer =='1') && ($main_menu =='1') && ($column_left)) { ?>col-md-offset-3 col-lg-offset-3<?php } ?>" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" >
  ...
  <div class="row">
  <?php if(($menu_open_manufacturer =='1') && ($main_menu =='1') && ($column_left)) { ?>
      ...
      <div itemprop="name" content='<?php echo $heading_title; ?>' class="row row-price">
        ...
        <div class="product-layout product-grid <?php echo $cols_class;?>">
          <div itemtype="http://schema.org/Product" itemprop="itemListElement" itemscope class="product-thumb">
			<?php if($config_on_off_manufacturer_page_quickview =='1'){?>
            ...
            <div class="image">
				...
				<?php if ($ns_on_off_manufacturer_page_slider_additional_image =='1') { ?>
				...
				<?php } elseif($ns_on_off_manufacturer_page_slider_additional_image =='2') { ?>
		  ...
		  <div class="actions-quick-order grid-quick-order">
				<div class="quick-order">
					...
					<?php if($ns_on_off_manufacturer_page_fastorder !='0'){ ?>
            ...
            <?php if($ns_on_off_manufacturer_page_model_product !='0') { ?>
					<div class="product-model"><?php echo $product['model']?></div>
			<?php } ?>
			<?php if($ns_on_off_manufacturer_page_description !='0') { ?>
			...
			<?php } ?>
			 <?php if ($show_options) { ?>
							...
							<?php } ?>
								...
								<?php } ?>	
             <?php if ($ns_on_off_manufacturer_page_rating !='0') { ?>
				<div class="rating" itemscope itemprop="aggregateRating" itemtype="http://schema.org/AggregateRating">
				 ...
				 <span class="rating-box">
                  ...
                  <?php } ?>
                  <?php } ?>
				  <?php if ($ns_on_off_manufacturer_page_quantity_reviews !='0') { ?>
				...
				<div class="actions">
					<?php if($ns_on_off_manufacturer_page_wishlist !='0') { ?>
					...
					<?php } ?>
						<?php if($ns_on_off_manufacturer_page_compare !='0') { ?>
...
<?php if ($ns_on_off_manufacturer_page_slider_additional_image !='0') { ?>
<script type="text/javascript">
...
if (localStorage.getItem('display') != 'price'){
	$(".additional-image").removeClass('hidden');
		$(".image-carousel-category").owlCarousel({
			...
			transitionStyle: '<?php echo $ns_select_manufacturer_page_additional_animate_method;?>'
		});
}
